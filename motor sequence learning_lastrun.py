...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Hiya\\OneDrive\\Desktop\\lab in psychology\\motor sequence learning\\motor sequence learning_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=12.0, method='sequential', 
        ...
        trialList=data.importConditions('C:/Users/Hiya/OneDrive/Desktop/lab in psychology/data/sequence condition.xlsx'),
    ...
    # set up handler to look after randomisation of conditions etc
    trials_2 = data.TrialHandler(nReps=12.0, method='fullRandom', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('C:/Users/Hiya/OneDrive/Desktop/lab in psychology/data/sequence condition.xlsx'),
    ...
    for thisTrial_2 in trials_2:
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed 12.0 repeats of 'trials_2'
